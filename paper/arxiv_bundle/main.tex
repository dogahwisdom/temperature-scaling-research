...
$T_{\mathrm{oracle}}/T_{\mathrm{hard}}$ ratio ranges from 1.19 to 1.32,
...
configurations, from 1.19 (ResNet-18) to 3.48 (DistilBERT on
...
temperature scaling exceed 8 in five of the eight configurations whose
reported standard deviation does not round to 0.000 at three decimals,
and exceed 18 in five language-heavy cases. H2 is supported in vision
and on ChaosNLI-S; ChaosNLI-M is inconclusive. H3 is supported: the mean
language gap (0.079) is about 30 times the mean vision gap (0.003) when
